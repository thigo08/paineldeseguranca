...
public class DelegateCrudAppGuardianHelper<T, I, C extends Crud<T, I>> extends DelegateCrud<T, I, C> {
	...
	private AppGuardianConfigurationBC appGuardianConfigurationBC = Beans
			.getReference(AppGuardianConfigurationBC.class);

	private AppGuardianConfiguration config = appGuardianConfigurationBC
