...
import org.owasp.esapi.waf.business.MustMatchRuleBC;
...
@ViewController
@NextView("./mustmatchrule_edit.jsf")
@PreviousView("./mustmatchrule_list.jsf")
public class MustMatchRuleListMB extends AbstractListPageBean<MustMatchRule, Long> {
...
//	}
	...
	@Override
	protected List<MustMatchRule> handleResultList() {
		//throw new TesteException();
		return this.mustMatchRuleBC.findAll();
	}
