...
@ViewController
@NextView("./addsecureflagrule_edit.jsf")
@PreviousView("./addsecureflagrule_list.jsf")
public class AddSecureFlagRuleListMB extends AbstractListPageBean<AddSecureFlagRule, Long> {
...
//	}
	...
	@Override
	protected List<AddSecureFlagRule> handleResultList() {
		//throw new TesteException();
		return this.addSecureFlagRuleBC.findAll();
	}
