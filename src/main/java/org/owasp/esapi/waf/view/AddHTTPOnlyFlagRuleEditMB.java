...
public class AddHTTPOnlyFlagRuleEditMB extends AbstractEditPageBean<AddHTTPOnlyFlagRule, Long> {
	...
	public String delete() {
		this.addHTTPOnlyFlagRuleBC.delete(getId());
	...
	public String insert() {
		AddHTTPOnlyFlagRule addHTTPOnlyFlagRule = getBean();
		
		urlPathBC.insert(addHTTPOnlyFlagRule.getPath());
		
		this.addHTTPOnlyFlagRuleBC.insert(getBean());
		return getPreviousView();
	}
	...
	public String update() {
		this.addHTTPOnlyFlagRuleBC.update(getBean());
		return getPreviousView();
	}
